        ...
        this.tail.on("line", (line: string) => {
            ...
            }
            {
                ...
                if (match) {
                    ...
                    exec("pwsh.exe -C \".\\utils\\write-timestamp.ps1 -Pathes @('C:\\Program Files (x86)\\Steam\\userdata\\308230826\\760\\remote\\438100\\screenshots', '${env:USERPROFILE}\\Amazon Drive\\Pictures\\A8120', '${env:USERPROFILE}\\Amazon Drive\\Pictures\\Quest') -DestPath 'D:\\VRCImage\'\"").stdout?.on("data", (data: string) => {
